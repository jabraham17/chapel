...
#define CHPL_PARSER_REPORT(P_CONTEXT__, NAME__, LOC__, EINFO__...)       \
  P_CONTEXT__->report(                                                   \
    LOC__, CHPL_PARSER_GET_ERROR(P_CONTEXT__, NAME__, LOC__, ##EINFO__))
...
#define CHPL_LEXER_REPORT(SCANNER__, NLINES__, NCOLS__, NAME__, EINFO__...) \
  CHPL_LEXER_REPORT_ACTUAL(SCANNER__,                                       \
                           NLINES__,                                        \
                           NCOLS__,                                         \
                           /* MOVE_TO_END__ */ false,                       \
                           NAME__,                                          \
...
#define CHPL_LEXER_REPORT_END(                                                 \
  SCANNER__, NLINES__, NCOLS__, NAME__, EINFO__...)                            \
  CHPL_LEXER_REPORT_ACTUAL(                                                    \
    SCANNER__, NLINES__, NCOLS__, /* MOVE_TO_END__ */ true, NAME__, ##EINFO__)

#define CHPL_LEXER_REPORT_ACTUAL(                                              \
  SCANNER__, NLINES__, NCOLS__, MOVE_TO_END__, NAME__, EINFO__...)             \
  CHPL_PARSER_REPORT(yyget_extra(SCANNER__),                                   \
                     NAME__,                                                   \
