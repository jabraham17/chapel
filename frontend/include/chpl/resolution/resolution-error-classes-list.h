...
ERROR_CLASS(AmbiguousIdentifier,
            ...
            bool,
            resolution::MatchingIdsWithName,
...
ERROR_CLASS(AssignFieldBeforeInit,
            const uast::FnCall*,
            std::vector<std::pair<const uast::VarLikeDecl*, ID>>)
ERROR_CLASS(CallToThrowingFunctionRelaxed,
            const uast::FnCall*,
            const resolution::UntypedFnSignature*)
ERROR_CLASS(CallToThrowingFunctionStrict,
            const uast::FnCall*,
            const resolution::UntypedFnSignature*)
ERROR_CLASS(CallToThrowingFunctionFromNon,
            const uast::FnCall*,
            const resolution::UntypedFnSignature*)
ERROR_CLASS(ConstRefCoercion,
            const uast::AstNode*,
            resolution::MostSpecificCandidate)
...
ERROR_CLASS(EnumAbstract,
            const uast::AstNode*,
            std::string,
            const types::EnumType*,
            const types::Type*)
ERROR_CLASS(EnumInitializerNotParam,
            const uast::EnumElement*,
            types::QualifiedType)
...
ERROR_CLASS(IncompatibleYieldTypes,
            const uast::AstNode*,
            std::vector<std::tuple<uast::Function::IteratorKind,
                                   types::QualifiedType,
                                   const resolution::TypedFnSignature*>>)
ERROR_CLASS(InterfaceAmbiguousFn,
            const types::InterfaceType*,
            ID,
            const uast::Function*,
            std::vector<const resolution::TypedFnSignature*>)
...
ERROR_CLASS(InterfaceMissingAssociatedType,
            ...
            const uast::Variable*,
            resolution::CallInfo,
            std::vector<resolution::ApplicabilityResult>)
...
ERROR_CLASS(InvalidContinueBreakTarget,
            ...
            ID,
            types::QualifiedType)
ERROR_CLASS(InvalidDomainCall,
            const uast::FnCall*,
            std::vector<types::QualifiedType>)
ERROR_CLASS(InvalidImplementsActual,
            const uast::Implements*,
            const uast::AstNode*,
            types::QualifiedType)
ERROR_CLASS(InvalidImplementsArity,
            const uast::Implements*,
            const types::InterfaceType*,
            std::vector<types::QualifiedType>)
ERROR_CLASS(InvalidImplementsInterface,
            const uast::Implements*,
            types::QualifiedType)
...
ERROR_CLASS(InvalidSparseSubdomainCall,
            const uast::FnCall*,
            types::QualifiedType)
ERROR_CLASS(InvalidNewTarget, const uast::New*, types::QualifiedType)
ERROR_CLASS(InvalidParamCast,
            const uast::AstNode*,
            types::QualifiedType,
            types::QualifiedType)
ERROR_CLASS(InvalidSuper, const uast::AstNode*, types::QualifiedType)
ERROR_CLASS(InvalidTupleCast,
            const uast::AstNode*,
            const types::TupleType*,
            const types::TupleType*,
            const types::Type*,
            const types::Type*)
ERROR_CLASS(IteratorsInOtherScopes,
            const uast::AstNode*,
            const resolution::TypedFnSignature*,
            std::vector<const resolution::TypedFnSignature*>)
...
ERROR_CLASS(MissingFormalInstantiation,
            const uast::AstNode*,
            std::vector<std::tuple<const uast::Decl*, types::QualifiedType>>)
ERROR_CLASS(MismatchedInitializerResult,
            const uast::AstNode*,
            const types::CompositeType*,
            const types::CompositeType*,
            std::vector<std::tuple<ID,
                                   chpl::UniqueString,
                                   types::QualifiedType,
                                   types::QualifiedType>>)
ERROR_CLASS(ModuleAsVariable,
            ...
            const uast::AstNode*,
            const uast::Module*)
ERROR_CLASS(MultipleEnumElems,
            const uast::AstNode*,
            chpl::UniqueString,
            const uast::Enum*,
            std::vector<ID>)
ERROR_CLASS(MultipleInheritance,
            const uast::Class*,
            const uast::AstNode*,
            const uast::AstNode*)
ERROR_CLASS(MultipleQuestionArgs,
            const uast::FnCall*,
            const uast::AstNode*,
            const uast::AstNode*)
ERROR_CLASS(NestedClassFieldRef,
            ...
            const uast::AstNode*,
            ID)
ERROR_CLASS(NoMatchingCandidates,
            const uast::AstNode*,
            resolution::CallInfo,
            std::vector<resolution::ApplicabilityResult>,
            std::vector<const uast::VarLikeDecl*>)
ERROR_CLASS(NoMatchingSuper,
            const uast::AstNode*,
            resolution::CallInfo,
            std::vector<resolution::ApplicabilityResult>,
            std::vector<const uast::VarLikeDecl*>,
            std::vector<std::pair<ID, ID>>)
ERROR_CLASS(NonClassInheritance,
            const uast::AggregateDecl*,
            const uast::AstNode*,
            const types::Type*)
ERROR_CLASS(NonIterable,
            const uast::AstNode*,
            const uast::AstNode*,
            types::QualifiedType,
            std::vector<std::tuple<uast::Function::IteratorKind,
                                   chpl::resolution::TheseResolutionResult>>)
ERROR_CLASS(NoMatchingEnumValue,
            const uast::AstNode*,
            const types::EnumType*,
            types::QualifiedType)
ERROR_CLASS(NotInModule, const uast::Dot*, ID, UniqueString, ID, bool)
ERROR_CLASS(NoTypeForEnumElem,
            const uast::Enum*,
            const uast::EnumElement*,
            types::QualifiedType,
            const uast::EnumElement*,
...
WARNING_CLASS(PotentiallySurprisingShadowing,
              ID,
              UniqueString,
              resolution::MatchingIdsWithName,
              std::vector<resolution::ResultVisibilityTrace>,
...
ERROR_CLASS(RaceyOutInoutInPromotion,
            const uast::AstNode*,
            resolution::MostSpecificCandidate)
ERROR_CLASS(Recursion, UniqueString)
ERROR_CLASS(RecursionFieldDecl,
            const uast::AstNode*,
            const uast::AggregateDecl*,
            const types::CompositeType*,
            std::vector<TraceElement>)
ERROR_CLASS(RecursionModuleStmt,
            const uast::AstNode*,
            const uast::Module*,
            std::vector<TraceElement>)
ERROR_CLASS(Redefinition,
            ID,
            UniqueString,
            resolution::MatchingIdsWithName,
            std::vector<resolution::ResultVisibilityTrace>)
ERROR_CLASS(ReductionAssignNonIdentifier, const uast::OpCall*)
ERROR_CLASS(ReductionAssignNotReduceIntent,
            const uast::OpCall*,
            const uast::AstNode*)
ERROR_CLASS(ReductionAssignInvalidRhs,
            const uast::OpCall*,
            const uast::ReduceIntent*,
            const uast::AstNode*,
            resolution::CallInfo)
ERROR_CLASS(ReductionIntentChangesType,
            const uast::ReduceIntent*,
            const uast::AstNode*,
            types::QualifiedType,
            types::QualifiedType)
...
ERROR_CLASS(SplitInitMismatchedConditionalTypes,
            const uast::Variable*,
            const uast::AstNode*,
...
ERROR_CLASS(SyntacticGenericityMismatch,
            const uast::Decl*,
            const types::Type::Genericity,
            const types::Type::Genericity,
            types::QualifiedType)
WARNING_CLASS(FieldWithGenericManagement, const uast::Decl*)
WARNING_CLASS(TertiaryUseImportUnstable,
              UniqueString,
              const uast::AstNode*,
              const uast::VisibilityClause*,
              const resolution::Scope*,
              resolution::VisibilityStmtKind)
ERROR_CLASS(ThrowInNonThrowingFunction,
            const uast::Throw*,
            const uast::Function*)
ERROR_CLASS(ThrowUnhandled,
            const uast::FnCall*,
            const resolution::UntypedFnSignature*)
ERROR_CLASS(TryNoCatchAll, const uast::Try*)
ERROR_CLASS(TupleDeclAssignMismatchedElems,
            const uast::AstNode*,
            const types::TupleType*)
...
ERROR_CLASS(TupleExpansionNonTuple,
            const uast::FnCall*,
            const uast::OpCall*,
            types::QualifiedType)
ERROR_CLASS(TupleIndexOOB,
            const uast::Call*,
            const types::TupleType*,
            const int)
ERROR_CLASS(TupleCastSizeMismatch,
            const uast::AstNode*,
            const types::TupleType*,
            const types::TupleType*)
ERROR_CLASS(UnknownEnumElem,
            const uast::AstNode*,
            chpl::UniqueString,
            const uast::Enum*)
...
WARNING_CLASS(UseImportMultiplyMentioned,
              ...
              const uast::AstNode*,
              const uast::AstNode*)
ERROR_CLASS(UseImportNotModule,
            const ID,
...
ERROR_CLASS(VariableWithoutInitOrType,
            const uast::AstNode*,
            ID,
            chpl::UniqueString)
