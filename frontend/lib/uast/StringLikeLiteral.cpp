...
void StringLikeLiteral::dumpFieldsInner(const DumpSettings& s) const {
  ...
  switch (quotes_) {
    case StringLikeLiteral::SINGLE: q = "'"; break;
    case StringLikeLiteral::DOUBLE: break;
    case StringLikeLiteral::TRIPLE_SINGLE:
      q = "'";
      suffix = " triple-single";
      break;
    case StringLikeLiteral::TRIPLE_DOUBLE: suffix = " triple-double"; break;
  }

  s.out << q << escapeStringC(value().str()) << q << suffix;
}
