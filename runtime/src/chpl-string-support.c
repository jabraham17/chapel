...
c_string
string_copy(c_string x, int64_t lineno, int32_t filename)
{
  char *z;
...
c_string
string_concat(c_string x, c_string y, int64_t lineno, int32_t filename) {
  char* z;
  size_t xlen;
  size_t ylen;
...
c_string
string_select(c_string x, int low, int high, int stride, int64_t lineno, int32_t filename) {
  char* result = NULL;
  char* dst = NULL;
  int size;
  c_string src;
...
c_string
string_index(c_string x, int i, int64_t lineno, int32_t filename) {
  char* buffer;
