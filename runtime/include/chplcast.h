...
int8_t c_string_to_int8_t(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
int16_t c_string_to_int16_t(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
int32_t c_string_to_int32_t(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
int64_t c_string_to_int64_t(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
uint8_t c_string_to_uint8_t(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
uint16_t c_string_to_uint16_t(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
uint32_t c_string_to_uint32_t(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
uint64_t c_string_to_uint64_t(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);

chpl_bool c_string_to_chpl_bool(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
...
_real32 c_string_to_real32(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
_real64 c_string_to_real64(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
_imag32 c_string_to_imag32(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
_imag64 c_string_to_imag64(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
_complex64 c_string_to_complex64(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
_complex128 c_string_to_complex128(c_string str, chpl_bool* err, int64_t lineno, int32_t filename);
