...
static VarSymbol* addFieldAccess(Symbol* receiver,
...
static void setDefinedConstForDomainField(Symbol* thisSym,
                                          Symbol* fieldSym,
                                          Expr* nextExpr,
                                          Symbol* isConst);
...
static VarSymbol* addFieldAccess(Symbol* receiver,
  ...
  CallExpr* getField = new CallExpr(
    PRIM_MOVE, fieldRef, new CallExpr(primTag, receiver, fieldSym));
...
static void setDefinedConstForDomainSymbol(Symbol* domainSym,
  ...
  VarSymbol* domInstance = addFieldAccess(domainSym,
                                          "_instance",
                                          insBeforeMarker,
                                          insAfterMarker,
                                          /*asRef=*/true);

  VarSymbol* refToDefinedConst = addFieldAccess(domInstance,
                                                "definedConst",
                                                insBeforeMarker,
                                                insAfterMarker,
                                                /*asRef=*/true);
  ...
  CallExpr* setDefinedConst =
    new CallExpr(PRIM_MOVE, refToDefinedConst, isConst);
...
void setDefinedConstForDomainSymbol(Symbol* domainSym,
  ...
  setDefinedConstForDomainSymbol(
    domainSym, insBeforeMarker, insAfterMarker, isConst);
...
static void setDefinedConstForDomainField(Symbol* thisSym,
  ...
  VarSymbol* domSym = addFieldAccess(thisSym,
                                     fieldSym->name,
                                     insBeforeMarker,
                                     insAfterMarker,
                                     /* asRef = */ false);
  setDefinedConstForDomainSymbol(
    domSym, insBeforeMarker, insAfterMarker, isConst);
}
