...
bool AstVisitorTraverse::enterAggrType(AggregateType* node) { return true; }
...
bool AstVisitorTraverse::enterEnumType(EnumType* node) { return true; }
...
bool AstVisitorTraverse::enterArgSym(ArgSymbol* node) { return true; }

void AstVisitorTraverse::exitArgSym(ArgSymbol* node) {}

void AstVisitorTraverse::visitEnumSym(EnumSymbol* node) {}

bool AstVisitorTraverse::enterFnSym(FnSymbol* node) { return true; }
...
bool AstVisitorTraverse::enterModSym(ModuleSymbol* node) { return true; }

void AstVisitorTraverse::exitModSym(ModuleSymbol* node) {}

bool AstVisitorTraverse::enterTypeSym(TypeSymbol* node) { return true; }

void AstVisitorTraverse::exitTypeSym(TypeSymbol* node) {}

void AstVisitorTraverse::visitVarSym(VarSymbol* node) {}

bool AstVisitorTraverse::enterCallExpr(CallExpr* node) { return true; }
...
bool AstVisitorTraverse::enterDefExpr(DefExpr* node) { return true; }

void AstVisitorTraverse::exitDefExpr(DefExpr* node) {}

bool AstVisitorTraverse::enterNamedExpr(NamedExpr* node) { return true; }
...
bool AstVisitorTraverse::enterIfExpr(IfExpr* node) { return true; }
...
bool AstVisitorTraverse::enterLoopExpr(LoopExpr* node) { return true; }

void AstVisitorTraverse::exitLoopExpr(LoopExpr* node) {}

bool AstVisitorTraverse::enterBlockStmt(BlockStmt* node) { return true; }

void AstVisitorTraverse::exitBlockStmt(BlockStmt* node) {}

bool AstVisitorTraverse::enterForallStmt(ForallStmt* node) { return true; }

void AstVisitorTraverse::exitForallStmt(ForallStmt* node) {}

bool AstVisitorTraverse::enterWhileDoStmt(WhileDoStmt* node) { return true; }

void AstVisitorTraverse::exitWhileDoStmt(WhileDoStmt* node) {}

bool AstVisitorTraverse::enterDoWhileStmt(DoWhileStmt* node) { return true; }

void AstVisitorTraverse::exitDoWhileStmt(DoWhileStmt* node) {}

bool AstVisitorTraverse::enterCForLoop(CForLoop* node) { return true; }

void AstVisitorTraverse::exitCForLoop(CForLoop* node) {}

bool AstVisitorTraverse::enterForLoop(ForLoop* node) { return true; }

void AstVisitorTraverse::exitForLoop(ForLoop* node) {}

bool AstVisitorTraverse::enterParamForLoop(ParamForLoop* node) { return true; }

void AstVisitorTraverse::exitParamForLoop(ParamForLoop* node) {}

bool AstVisitorTraverse::enterCondStmt(CondStmt* node) { return true; }

void AstVisitorTraverse::exitCondStmt(CondStmt* node) {}

void AstVisitorTraverse::visitEblockStmt(ExternBlockStmt* node) {}

bool AstVisitorTraverse::enterGotoStmt(GotoStmt* node) { return true; }
...
bool AstVisitorTraverse::enterDeferStmt(DeferStmt* node) { return true; }

void AstVisitorTraverse::exitDeferStmt(DeferStmt* node) {}

bool AstVisitorTraverse::enterTryStmt(TryStmt* node) { return true; }

void AstVisitorTraverse::exitTryStmt(TryStmt* node) {}

bool AstVisitorTraverse::enterCatchStmt(CatchStmt* node) { return true; }
