...
class InitNormalize {
 public:
  ...
  void initializeFieldsAtTail(BlockStmt* block, DefExpr* endField = NULL);
  void initializeFieldsBefore(Expr* insertBefore, DefExpr* endField = NULL);
  ...
  Expr* fieldInitFromInitStmt(DefExpr* field, CallExpr* callExpr);
 ...
 private:
  ...
  Expr* genericFieldInitTypeWoutInit(Expr* insertBefore, DefExpr* field) const;
  ...
  Expr* fieldInitTypeWoutInit(Expr* insertBefore, DefExpr* field) const;
