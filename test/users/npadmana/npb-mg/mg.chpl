...
/* Multigrid step
*/
proc mgstep(ref U, V, ref Levels) {
  var t1 : stopwatch;
  t1.clear();
 ...
 */
proc restrict(ref coarse:[?coarseDom] real, ref fine : [?FineDom]real) {
...
*/
proc prolong(ref fine:[?fineDom]real, ref coarse:[?coarseDom]real) {
  coarse.updateFluff();
