...
proc convolve_and_calculate(Image: [] int(8), centerPoints : ?, LeftMaskDomain : ?, CenterMaskDomain : ?, RightMaskDomain : ?, dissimilarity : [] real(64), ref Output: [] real(64), d_size : int, Mask_Size : int,  t: stopwatch) : [] {
